...
const InviterPreference = () => {
	...
	const { selectedFriends, toggleSelectFriend, clearAllSelection } =
		useSelectedFriends();
	...
	const handleConfirm = useCallback(() => {
		...
		console.log(
			"InviterPreference - 確定時のselectedFriends:",
			selectedFriends,
		);
		console.log(
			"InviterPreference - selectedFriendsの各要素:",
	...
	if (error)
		return (
			<ErrorScreen error={error} onRetry={retryFetch} onBack={handleBack} />
		);
