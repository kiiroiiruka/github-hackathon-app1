...
const sections = [
  {
    title: "第1条（適用）",
    body: "本規約は、本サービスの利用に関する一切に適用されます。",
  },
  {
    title: "第2条（利用登録）",
    body: "ユーザーは当社の定める方法により登録を行うものとします。",
  },
  {
    title: "第3条（禁止事項）",
    body: "法令または公序良俗に反する行為、他者の権利侵害などを禁止します。",
  },
  {
    title: "第4条（免責事項）",
    body: "当社は、サービスに関して生じた損害について、一切の責任を負いません。",
  },
  {
    title: "第5条（規約の変更）",
    body: "当社は、本規約を必要に応じて変更できるものとします。",
  },
];
