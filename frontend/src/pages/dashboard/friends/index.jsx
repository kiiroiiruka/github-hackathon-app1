...
const FriendsAddScreen = () => {
  ...
  const _handleSearchFriend = async () => {
        ...
        <div className="bg-white rounded-lg shadow-md p-4 mb-6">
          ...
          {targetUser && (
            <div className="mt-3 p-3 bg-blue-50 rounded-md flex items-center gap-3">
              ...
              {/* ユーザー情報 */}
              <div className="flex-1 min-w-0">
                <p className="font-medium truncate">{targetUser.displayName || "ユーザー"}</p>
                ...
                {targetUser.userShortMessage && (
                  <p className="text-sm text-gray-600 truncate">"{targetUser.userShortMessage}"</p>
                )}
                ...
                {targetUser.createdAt && (
                  <p className="text-xs text-gray-500 truncate">
                    アカウント作成日:{" "}
                    {new Date(targetUser.createdAt.toDate()).toLocaleDateString("ja-JP")}
                  </p>
                )}
              </div>
            </div>
