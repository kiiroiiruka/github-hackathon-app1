...
import { getUser, logout, updateUserMessage, removeFriend, acceptFriendRequest, rejectFriendRequest } from "../../../firebase";
...
function UserInformation() {
	...
	const handleRemoveFriend = async () => {
		...
		const ok = window.confirm("フレンドを削除しますか？この操作は元に戻せません。");
		if (!ok) return;
		try {
