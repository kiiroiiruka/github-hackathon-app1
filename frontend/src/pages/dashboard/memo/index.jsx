              ...
              >
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex items-center gap-2 ml-2">
                    <span className="text-xs text-gray-500">{formatDate(memo.updatedAt)}</span>
                    <button
                      type="button"
                ...
                <p className="text-gray-600 text-sm mb-3 line-clamp-3">{memo.content}</p>

                <div className="flex justify-between items-center text-xs text-gray-500">
                  <span>作成: {formatDate(memo.createdAt)}</span>
                  <span className="bg-gray-100 px-2 py-1 rounded">{memo.content.length}文字</span>
                </div>
              </div>
            ))}
          </div>
