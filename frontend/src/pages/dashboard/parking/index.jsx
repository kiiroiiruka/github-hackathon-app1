									...
									<div>
										...
										<div className="text-blue-700">
											{parkingInfo.arrivalTime
												? new Date(parkingInfo.arrivalTime).toLocaleString(
														"ja-JP",
													)
												: "未設定"}
										</div>
									...
									<div>
										...
										<div className="text-green-700">
											{parkingInfo.departureTime
												? new Date(parkingInfo.departureTime).toLocaleString(
														"ja-JP",
													)
												: "未設定"}
										</div>
							...
							<Card className="mb-6">
								<div className="text-center mb-4">
									...
									<div className="text-xs text-gray-500 mb-3">
										現在地: {nowPosition.lat.toFixed(6)},{" "}
										{nowPosition.lng.toFixed(6)}
									</div>
									...
									>
										...
										{(() => {
											const isSameLocation =
												Math.abs(nowPosition.lat - parkingInfo.position.lat) <
													0.0001 &&
												Math.abs(nowPosition.lng - parkingInfo.position.lng) <
													0.0001;
