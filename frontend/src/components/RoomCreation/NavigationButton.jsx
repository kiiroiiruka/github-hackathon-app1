  ...
  return (
    <button
      ...
      className={`flex items-center justify-between p-4 border-2 ${borderStyle} ${
        disabled ? "border-gray-200 bg-gray-50 cursor-not-allowed opacity-50" : "border-gray-300"
    ...
    >
      ...
      <span
        className={`${disabled ? "text-gray-300" : "text-gray-400"} transition-colors ${disabled ? "" : arrowColor}`}
      >
        →
      </span>
    </button>
